...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/IVANMERZOV/Desktop/MODERATOR_ASSHOLE/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/IVANMERZOV/Desktop/MODERATOR_ASSHOLE/venv/bin/deactivate.nu'
